...
<html lang="fr">
    ...
    <body>
        ...
        <H1>NOTRE CARTE</H1>
        <p>Le chef Antoine Michant revisite pour vous les grands classiques de la Savoie à travers une carte créative et savoureuse. Entre recettes de terroir et inspirations modernes, vivez une expérience gastronomique unique au cœur des Alpes.</p>
        </section>
